...
const EditProfile = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="EditProfile flex h-auto w-full flex-col justify-start bg-slate-200 px-4 md:flex-row md:justify-between md:pt-20 pt-36 pb-12">
        <div className="md:h-screen md:w-1/5">
          ...
          <div className="mt-7 h-auto md:border-b-0 border-b-2 w-full bg-white md:h-80 p-2">
            <div className=" flex items-end w-full ">
              ...
              <p className="lg:text-base text-sm font-semibold ml-3">
                ACCOUNT SETTINGS
              </p>
            </div>
            ...
            <ul className="w-full m-auto space-y-2  mt-8">
              <li
                className={`text-start text-lg font-normal flex items-center cursor-pointer pl-11 w-full ${
                  SelectedProfile === "PersonalInfo" && "bg-blue-100"
                }  h-12`}
                onClick={() => {
              ...
              <li
                className={`text-start text-lg font-normal flex items-center cursor-pointer pl-11 w-full ${
                  SelectedProfile === "manageAddress" && "bg-blue-100 h-12"
                } `}
                onClick={() => {
